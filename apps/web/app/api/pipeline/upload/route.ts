...
export async function POST(req: Request) {
  ...
  const { jobId, seoOutput, avSyncOutput, shortsOutput, imagesOutput } = body as {
    jobId: string;
    seoOutput: SEOOutput;
    avSyncOutput: AvSyncOutputType;
    shortsOutput: ShortsGenOutputType;
    imagesOutput?: { thumbnailS3Key?: string };
  };
    ...
    try {
      ...
      const output = await invokeUploader({
        ...
        mainVideo: {
          ...
          scheduledTime,
          // Use thumbnail generated by TONY in step 8; fall back to conventional path
          thumbnailS3Key:
            imagesOutput?.thumbnailS3Key ?? `jobs/${jobId}/thumbnail_a.jpg`,
        },
